...
**WHAT**: Free, lightweight platform to deploy your own, secure mail, chat and video conference services, or build your own applications on the platform. Funded by [Open Technology Fund](https://www.opentech.fund), eclips.is is administered by Amsterdam-based tech company [Greenhost](https://greenhost.net).
